...
const Navbar = () => {
  ...
  return (
      ...
      <nav className="relative flex flex-wrap items-center justify-between  py-3 bg-zinc-950 mb-3 z-10 shadow">
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <a
              className="text-2xl md:text-3xl font-bold leading-relaxed inline-block mr-4 px-2 py-2 whitespace-nowrap text-zinc-100"
              href="#pablo"
            >
              Product&co
            </a>
            <button
              className="text-zinc-100 cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-transparent rounded bg-transparent block lg:hidden outline-none focus:outline-none"
              type="button"
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto justify-center items-center">
              <li className="nav-item">
                <a
                  className="px-3 py-2 flex items-center text-md leading-snug text-zinc-100 hover:opacity-75"
                  href="/admin"
                >
              ...
              <li className="nav-item">
               ...
               <li className="nav-item">
                ...
                >
                  {/* <i className="fab fa-twitter text-lg leading-lg text-purple-700 opacity-75"></i> */}
                  <span className="ml-2">Category & Sub</span>
                </a>
              </li>
               <li className="nav-item">
                <a
              ...
              <li>
                <div className="relative inline-block text-left">
                  <button
                    ...
                    type="button"
                    className="flex items-center px-4 py-2 text-md font-medium bg-blue-400 hover:bg-blue-700 text-zinc-100 rounded-md focus:outline-none focus-visible:ring focus-visible:ring-gray-400 focus-visible:ring-opacity-50"
                  >
    ...
    //       {/* <button
    //         onClick={logout}
    //         className="bg-blue-500 hover:bg-blue-700 text-zinc-100 font-bold py-2 px-4 rounded"
    //       >
    //         Logout
    //       </button> */}
    //     </div>
